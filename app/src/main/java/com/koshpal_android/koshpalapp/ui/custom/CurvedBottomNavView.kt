...
class CurvedBottomNavView @JvmOverloads constructor(
    ...
    private val notchDepth = 32f
    private val notchWidth = 120f
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        drawCurvedBackground(canvas, width, height, centerX)
    }
    ...
    private fun drawCurvedBackground(canvas: Canvas, width: Float, height: Float, centerX: Float) {
        path.reset()
