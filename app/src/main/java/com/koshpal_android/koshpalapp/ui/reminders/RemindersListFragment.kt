...
class RemindersListFragment : Fragment() {
    ...
    private fun setStatusBarColor() {
        activity?.window?.let { window ->
            ...
            android.util.Log.d("RemindersListFragment", "🎨 Status bar and navigation bar set to dark")
        }
    }
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        // Restore status bar and navigation bar to dark when leaving RemindersListFragment
        activity?.window?.let { window ->
            window.statusBarColor = androidx.core.content.ContextCompat.getColor(requireContext(), android.R.color.black)
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                window.navigationBarColor = androidx.core.content.ContextCompat.getColor(requireContext(), android.R.color.black)
            ...
            android.util.Log.d("RemindersListFragment", "🎨 Status bar and navigation bar restored to dark")
        }
        _binding = null
    }
